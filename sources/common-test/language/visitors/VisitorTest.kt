...
class VisitorTest {
	...
	fun `visits a document`() {
		...
		val expectedStacks: List<List<String>> = listOf(
			...
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)"),
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)", "Name(3)"),
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)", "NamedTypeRef(3)"),
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)", "NamedTypeRef(3)", "Name(4)"),
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)", "Directive(3)"),
			listOf("Document(0)", "InputObjectType(1)", "InputObjectArgumentDefinition(2)", "Directive(3)", "Name(4)"),
			...
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)"),
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)", "Name(3)"),
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)", "NamedTypeRef(3)"),
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)", "NamedTypeRef(3)", "Name(4)"),
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)", "Directive(3)"),
			listOf("Document(0)", "InputObjectTypeExtension(1)", "InputObjectArgumentDefinition(2)", "Directive(3)", "Name(4)"),
			...
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Name(4)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)", "Name(5)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "IntValue(4)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)"),
			listOf("Document(0)", "InterfaceType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)", "Name(5)"),
			...
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Name(4)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)", "Name(5)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "IntValue(4)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)"),
			listOf("Document(0)", "InterfaceTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)", "Name(5)"),
			...
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Name(4)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)", "Name(5)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "IntValue(4)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)"),
			listOf("Document(0)", "ObjectType(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)", "Name(5)"),
			...
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Name(4)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "NamedTypeRef(4)", "Name(5)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "IntValue(4)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)"),
			listOf("Document(0)", "ObjectTypeExtension(1)", "FieldDefinition(2)", "FieldArgumentDefinition(3)", "Directive(4)", "Name(5)"),
			...
			listOf("Document(0)", "CustomScalarType(1)"),
			listOf("Document(0)", "CustomScalarType(1)", "StringValue(2)"),
			listOf("Document(0)", "CustomScalarType(1)", "Name(2)"),
			listOf("Document(0)", "CustomScalarType(1)", "Directive(2)"),
			listOf("Document(0)", "CustomScalarType(1)", "Directive(2)", "Name(3)"),
			...
			listOf("SyntheticNode(0)", "BooleanType(1)"),
			listOf("SyntheticNode(0)", "BooleanType(1)", "Name(2)"),
			listOf("SyntheticNode(0)"),
			listOf("SyntheticNode(0)", "BooleanType(1)"),
			listOf("SyntheticNode(0)", "BooleanType(1)", "Name(2)"),
			listOf("FloatType(0)"),
			listOf("FloatType(0)", "Name(1)"),
			listOf("IdType(0)"),
			listOf("IdType(0)", "Name(1)"),
			listOf("IntType(0)"),
			listOf("IntType(0)", "Name(1)"),
			listOf("StringType(0)"),
			listOf("StringType(0)", "Name(1)")
		)

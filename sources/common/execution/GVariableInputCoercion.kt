...
interface GVariableInputCoercion<Environment : Any> {
	...
	companion object {
		...
		fun <Environment : Any> default(): GVariableInputCoercion<Environment> =
			Default as GVariableInputCoercion<Environment>
	}


	interface Decorator<Environment : Any> : GVariableInputCoercion<Environment> {

		val decorated: GVariableInputCoercion<Environment>
	...
	private object Default : GVariableInputCoercion<Any> {
		...
		override fun coerceListValue(
			...
			typeRef: GListTypeRef,
			variable: GVariableDefinition,
			context: GVariableInputCoercionContext<Any>
		): Any = when (value) {
		...
		override fun coerceValues(
			...
			variables.associate { variable ->
				context.path.withName(variable.name) {
					variable.name to context.coercion.coerceValue(

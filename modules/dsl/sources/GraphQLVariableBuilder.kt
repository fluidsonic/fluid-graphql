 ...
 */
@GraphQLMarker
public sealed interface GraphQLVariableBuilder :
	GraphQLVariableBuilderScope,
 ...
 */
@GraphQLMarker
public sealed interface GraphQLVariableBuilderScope :
	...
	@kotlin.internal.LowPriorityInOverloadResolution // https://youtrack.jetbrains.com/issue/KT-645
...
private class GraphQLVariableBuilderImpl(private val name: String, private val type: GTypeRef) :
	...
	override fun build(): GVariableDefinition = GVariableDefinition(
...
public fun GraphQLVariableBuilder(name: String, type: GTypeRef): GraphQLVariableBuilder = GraphQLVariableBuilderImpl(name = name, type = type)

 ...
 */
@GraphQLMarker
public sealed interface GraphQLDirectiveBuilder :
...
@GraphQLMarker
public sealed interface GraphQLDirectiveBuilderScope :
	GraphQLValueContainerScope,
	GraphQLArgumentsContainerScope

private class GraphQLDirectiveBuilderImpl(private val name: String) :
	...
	override fun build(): GDirective = GDirective(
...
public fun GraphQLDirectiveBuilder(name: String): GraphQLDirectiveBuilder = GraphQLDirectiveBuilderImpl(name = name)

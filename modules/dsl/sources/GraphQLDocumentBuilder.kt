 ...
 */
@GraphQLMarker
public sealed interface GraphQLDocumentBuilder :
	GraphQLDocumentBuilderScope,
	GraphQLFragmentDefinitionContainer {
 ...
 */
public inline fun GraphQLDocumentBuilderScope.mutation(name: String? = null, configure: GraphQLOperationBuilderScope.() -> Unit) {
	when (this) {
 ...
 * @param name optional operation name.
 */
public inline fun GraphQLDocumentBuilderScope.query(name: String? = null, configure: GraphQLOperationBuilderScope.() -> Unit) {
	when (this) {
 ...
 * @param name optional operation name.
 */
public inline fun GraphQLDocumentBuilderScope.subscription(name: String? = null, configure: GraphQLOperationBuilderScope.() -> Unit) {
	when (this) {
...
@GraphQLMarker
internal class GraphQLDocumentBuilderImpl :
	GraphQLDocumentBuilder,
	GraphQLFragmentDefinitionContainerInternal {
...
public fun GraphQLDocumentBuilder(): GraphQLDocumentBuilder = GraphQLDocumentBuilderImpl()
 ...
 */
public inline fun GraphQL(configure: GraphQLDocumentBuilderScope.() -> Unit): GDocument = GraphQLDocumentBuilder().apply(configure).build()
...
public inline fun GraphQL.document(configure: GraphQLDocumentBuilderScope.() -> Unit): GDocument = GraphQLDocumentBuilder().apply(configure).build()

...
private class GraphQLValueListBuilderImpl : GraphQLValueListBuilder {
	...
	override fun build(): GListValue = GListValue(values.toList())
}

/** Creates a new [GraphQLValueListBuilder]. */
public fun GraphQLValueListBuilder(): GraphQLValueListBuilder = GraphQLValueListBuilderImpl()

/** Creates a nested [GListValue] inside a list builder. */
@Suppress("UnusedReceiverParameter")
public inline fun GraphQLValueListBuilder.list(configure: GraphQLValueListBuilder.() -> Unit): GListValue = GraphQLValueListBuilder().apply(configure).build()

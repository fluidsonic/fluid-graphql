...
private class GraphQLFragmentSelectionBuilderImpl(private val name: String) :
	GraphQLFragmentSelectionBuilder,
	...
	override fun build(): GFragmentSelection = GFragmentSelection(
...
public fun GraphQLFragmentSelectionBuilder(name: String): GraphQLFragmentSelectionBuilder = GraphQLFragmentSelectionBuilderImpl(name = name)

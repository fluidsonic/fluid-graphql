...
internal object ArgumentUniquenessRule : ValidationRule.Singleton() {
	...
	override fun onFieldSelection(selection: GFieldSelection, data: ValidationContext, visit: Visit) = checkArgUniqueness(selection.arguments, data)

	override fun onDirective(directive: GDirective, data: ValidationContext, visit: Visit) = checkArgUniqueness(directive.arguments, data)

...
class AstSchemaParsingErrorsTests {
	...
	fun testRejectsDirectiveWithIncorrectLocation() {
		assertSyntaxError(
			...
			message = "Syntax Error: 'INCORRECT_LOCATION' is not a valid directive location. Valid values are: " +
				"ARGUMENT_DEFINITION, DIRECTIVE_DEFINITION, ENUM, ENUM_VALUE, FIELD, FIELD_DEFINITION, FRAGMENT_DEFINITION, FRAGMENT_SPREAD, " +
				"INLINE_FRAGMENT, INPUT_FIELD_DEFINITION, INPUT_OBJECT, INTERFACE, MUTATION, OBJECT, QUERY, SCALAR, " +

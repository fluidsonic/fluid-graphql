...
public abstract class Visitor<out Result, in Data> {
	...
	public abstract class Hierarchical<out Result, in Data> : Typed<Result, Data>() {
		...
		override fun onInputObjectType(type: GInputObjectType, data: Data, visit: Visit): Result = onNamedType(type, data, visit)
		...
		public abstract class WithoutData<out Result> : Hierarchical<Result, Nothing?>() {
			...
			protected open fun onInputObjectType(type: GInputObjectType, visit: Visit): Result = onNamedType(type, visit)

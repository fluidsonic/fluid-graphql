...
public class GNullValue(origin: GDocumentPosition? = null, extensions: GNodeExtensionSet<GNullValue> = GNodeExtensionSet.empty()) :
	GValue(
	...
	override fun equals(other: Any?): Boolean = this === other || other is GNullValue
...
public fun GNullValue(): GNullValue = GNullValue.withoutOrigin
